...
class comment{
    ...
    public function __construct($id,$content,$img_url,$created_time,$discussion_id,$prev_comment,$create_user,$liked_num){
        $this->id = $id;
    ...
    public function arrify(){
        $data = array('id' => $this->id, 'content' => $this->content, 'img_url' => $this->img_url,
            ...
            'create_user' => $this->create_user, 'liked_num'=> $this->liked_num
        );
